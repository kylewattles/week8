...
console.log(`--------------------------
    ...
    let mygreeting = new Greeting("Kyle", "Nepal")
    mygreeting.hello()
    ...
    const myBook = new Book("Pride and Prejudice", "Jane Austin")
    myBook.describe()
    console.log(myBook.title)
    console.log(myBook.author);
    console.log(`${myBook.title}, ${myBook.author}`);

    const yourBook = new Book("Frankenstein", "Mary Shelley")
    yourBook.describe()
    console.log(`${yourBook.title}, ${yourBook.author}`);
    ...
    const fruit1 = new fruit("pomegranate", "red", "tart")
    const fruit2 = new fruit("banana", "yellow", "sweet")
     ...
     * ↓ YOUR CODE HERE ↓ */
      ...
      const child = new Child("Pugsley", 10)
